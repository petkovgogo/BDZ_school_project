...
class Schedule(models.Model):
    ...
    departure_time = models.TimeField(
        'departure time', default=None, null=True)
    arrival_time = models.TimeField('arrival time', default=None, null=True)
...
class Ticket(models.Model):
    ...
    ticket_type_id = models.ForeignKey(
        TicketType, related_name='ticket_type_id', default=None, on_delete=models.CASCADE)
...
class Route(models.Model):
    ...
    ticket_id = models.ForeignKey(
        Ticket, related_name='ticket_id', default=None, on_delete=models.CASCADE)
